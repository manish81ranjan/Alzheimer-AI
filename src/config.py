...
# ✅ Load .env locally (safe on Render too)
try:
...
class Config:
    ...
    Optional ENV:
      - FLASK_ENV=development|production
      - CORS_ORIGINS=http://localhost:5173,https://your-frontend.vercel.app OR *
      - MAX_CONTENT_LENGTH_MB=25
      - MODEL_PATH
      - GEMINI_API_KEY, GEMINI_MODEL
    """
    ...
    # -------------------- CORS --------------------
    # Accept comma-separated origins OR "*"
    # IMPORTANT: since app.py uses supports_credentials=False, "*" is allowed if you want.
    default_origins = [
        "http://localhost:5173",
        "http://127.0.0.1:5173",
        "https://alzheimer-ai-system-frontend.vercel.app",
    ]
